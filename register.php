...
?>
	<form action="" method="post">
		<ul>
			...
			<li>
				<h2>House Rules</h2>
				<p><a href='http://grasshopper-ot.com/houserules.php' target="_blank">READ HERE</a></p>
				<p>We reserve the right to delete, ban, do whatever they want with your account and your <br>
